...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['send_otp'])) {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $stmt = $conn->prepare("SELECT user_id, name FROM gym_users WHERE email = ? AND role = 'Member'");
            ...
            if ($result->num_rows > 0) {
                ...
                // Send OTP email
                if (sendEmail($email, "Password Reset OTP - Gym Management", "Hello " . $user['name'] . ",\n\nYour OTP for password reset is: " . $otp . "\n\nThis OTP is valid for 10 minutes.\n\nBest regards,\nGym Management Team")) {
        ...
        if ($entered_otp == $_SESSION['reset_otp']) {
            ...
            if ($stmt->execute()) {
                ...
                if (sendEmail($_SESSION['reset_email'], "New Password - Gym Management", "Hello,\n\nYour password has been reset successfully.\n\nNew Login Details:\nEmail: " . $_SESSION['reset_email'] . "\nPassword: " . $new_password . "\n\nPlease login and change your password.\n\nBest regards,\nGym Management Team")) {
                    ...
                    // Clear session data
                    unset($_SESSION['reset_otp'], $_SESSION['reset_email'], $_SESSION['reset_user_id']);
                    $step = 3;
                } else {
...
<head>
    <meta charset="UTF-8">
    <title>Forgot Password - Member</title>
...
<div class="reset-container">
    <div class="reset-header">
        ...
        <p class="text-muted">Member Account Recovery</p>
    </div>
